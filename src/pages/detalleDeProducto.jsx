...
function DetalleDeProducto() {
      ...
      <section className="product-detail py-5">
        <div className="container">
          <p className="text-center">
            Producto no encontrado. <Link to="/productos">Volver a productos</Link>
          </p>
        </div>
      </section>
    );
  ...
  const handleAddToCart = () => {
    ...
    // Construye un objeto producto para el contexto (puedes añadir más campos si los necesitas)
    ...
    // Llama al contexto para agregar (el contexto gestionará la suma de cantidades si ya existe)
    agregarProducto(productoParaCarrito, qty);

    setShowAlert(true);
    // cerrar alerta automáticamente en 2.5s
              ...
              <div className="product-details">
                <div className="detail-item mb-2">
                  ...
                  <span id="product-category">
                    {producto.category || producto.categoryLabel || "Sin categoría"}
                  </span>
                </div>
